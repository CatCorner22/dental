...
| 2026-08-08 | Curve Hero power-user cruelty sheet. Filed `knowledge/sources/adversarial-curve-power-user.md`: Favorites/Forms/QuickText/Care+ vs Fast Lane/paste; 8 never-switch; 4 tab-once concessions; trap = Forms clone / silent fill / ambient. |
