...
| 2026-08-08 | Adversarial temp-agency recruiter panel. Filed `knowledge/sources/adversarial-temp-agency-recruiter.md`: day-one kills on unset role, training-as-homework, shared iPad, Favorites gap; trap = shared temp login / soft audit / silent fill. |
