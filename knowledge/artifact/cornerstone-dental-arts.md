...
| 2026-08-08 | Adversarial OMFS/specialty referral hate panel. Filed `knowledge/sources/adversarial-hate-omfs-referral.md`: attacks thin GP handoffs (referral block, rationale, imaging interpretation); 4 fixes + trap against auto-authored specialty narrative. |
