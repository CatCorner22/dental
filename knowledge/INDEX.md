...
- **[USA litigation and documentation — claim-file research for risk-reduction rules](sources/litigation-documentation-research.md)** — Epistemic frame for the negative-proof problem; The Doctors Company 1,185-claim cohort (documentation in 19%, top gaps: findings/consent/rationale); MedPro/WSDA sparse-chart case; informed refusal, referral, and delayed-diagnosis patterns from public case studies; expert-review workflow; mapping table to `complete.*` rules and Byte advisor entries. Tags: dental, clinical-notes, risk-reduction, documentation, informed-consent, malpractice-claims, doctors-company, medpro, claim-files. Ingested: 2026-08-05.
